...
class OurBrandsFoodBeverages extends StatefulWidget {
  const OurBrandsFoodBeverages({super.key});

  @override
  State<OurBrandsFoodBeverages> createState() => _OurBrandsFoodBeveragesState();
}

class _OurBrandsFoodBeveragesState extends State<OurBrandsFoodBeverages>
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              const CHBanner(
                imagePath: 'images/our-brands-banner.png',
                title: 'OUR BRANDS',
                body:
                      ...
                      child: TabBar(
                          onTap: (value) {
                            if (value == 0) {
                              ...
                              context.go('our-brands-food-and-beverages');
                            } else {
                              context
                                  .go('our-brands-golf-and-active-lifestyle');
                            }
